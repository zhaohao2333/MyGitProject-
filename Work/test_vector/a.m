...
%-----------------------------------------------
    ...
    writecell(data_bin2,'C:\Users\zhaohao\Desktop\copy\TDC_spad\RTL\vector_1.txt','Delimiter',' ');
%----------------------------------------------    
...
%     fclose(fid);
    ...
    %databin = str2num(data_bin);
    writecell(int_bin2,'C:\Users\zhaohao\Desktop\copy\TDC_spad\RTL\vector_int.txt','Delimiter',' ');
...
%     sum(b-'0')
    ...
    %databin = str2num(data_bin);
    writecell(int_out_d2,'C:\Users\zhaohao\Desktop\copy\TDC_spad\RTL\vector_int_b.txt','Delimiter',' ');
