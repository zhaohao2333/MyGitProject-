...
add wave -noupdate /tb_tdc_his/busy
...
add wave -noupdate /tb_tdc_his/start
add wave -noupdate /tb_tdc_his/core_cnt
...
add wave -noupdate /tb_tdc_his/tdc_top_dut/busy
...
add wave -noupdate /tb_tdc_his/tdc_top_dut/counter_low
add wave -noupdate /tb_tdc_his/tdc_top_dut/counter_high
...
add wave -noupdate /tb_tdc_his/tdc_top_dut/range_d
add wave -noupdate /tb_tdc_his/tdc_top_dut/range_dd
...
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_num_cnt
add wave -noupdate /tb_tdc_his/tdc_top_dut/tri_en
add wave -noupdate /tb_tdc_his/tdc_top_dut/num_cnt
add wave -noupdate /tb_tdc_his/tdc_top_dut/TDC_tgate_n
add wave -noupdate /tb_tdc_his/tdc_top_dut/TDC_trigger_n
add wave -noupdate /tb_tdc_his/tdc_top_dut/start_phase_latch
add wave -noupdate /tb_tdc_his/tdc_top_dut/stop_phase_latch
add wave -noupdate /tb_tdc_his/tdc_top_dut/range_d_high
add wave -noupdate /tb_tdc_his/tdc_top_dut/range_dd_high
add wave -noupdate /tb_tdc_his/tdc_top_dut/range_d_low
add wave -noupdate /tb_tdc_his/tdc_top_dut/range_dd_low
add wave -noupdate /tb_tdc_his/tdc_top_dut/overflow_low
add wave -noupdate /tb_tdc_his/tdc_top_dut/overflow_high
add wave -noupdate /tb_tdc_his/tdc_top_dut/clk5_2
add wave -noupdate /tb_tdc_his/tdc_top_dut/clk5_2_i
...
add wave -noupdate /tb_tdc_his/tdc_top_dut/sync_inst0/vout1
add wave -noupdate /tb_tdc_his/tdc_top_dut/sync_inst0/vout0
...
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/num_cnt
...
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/tri_en
...
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/dec_valid_d
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/dec_valid_dd
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/dec_valid_ddd
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/dec_valid_dddd
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/out_valid
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/tof_num_cnt
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/tof_reg
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/sum1
add wave -noupdate /tb_tdc_his/tdc_top_dut/tof_cal_inst/sum2
...
WaveRestoreCursors {{Cursor 1} {51689 ns} 0}
...
update
WaveRestoreZoom {0 ns} {124320 ns}
